...
class _RegisterState extends State<Register> {
  ...
  final register = Get.find<RegisterController>();
                ...
                Padding(
                  ...
                  child: TextFormField(
                    validator: MultiValidator([
                      ...
                      MinLengthValidator(3,
                          errorText: 'Full Name should be atleast 3 charater'),
                    ]),
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  if (_formkey.currentState!.validate()) {
                                    ...
                                    controller.genderController.text = _selectedGender!;
                                    controller.religionController.text = _selectedAgama!;

                                    // Show a success alert upon successful registration
                                    showDialog(
                                      context: context,
