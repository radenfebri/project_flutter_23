    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        actions: <Widget>[
          ...
          TextButton(
            onPressed: () {
              // Hapus data sesi atau token yang sedang login di sini (sesuai kebutuhan)
              // Contoh: Anda bisa menghapus token dengan menghapus cookie atau menyimpannya dalam Shared Preferences.
